...
export const DottedGlowBackground = ({
  ...
  gap = 12,
  radius = 2,
  color = "rgba(255,255,255,0.15)", // adjusted default for dark theme
  darkColor,
  glowColor = "rgba(0, 170, 255, 0.4)", // adjusted default for dark theme
  darkGlowColor,
  colorLightVar,
  colorDarkVar,
  glowColorLightVar,
  ...
  useEffect(() => {
    ...
    // Precompute dot metadata for a grid and regenerate on resize
    let dots = [];
